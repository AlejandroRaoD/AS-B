...
export const CreateCatedraValidator = [
	body("name").exists().isString().trim().notEmpty(),
	body("description").exists().isString().trim(),
	body("programaId").exists().isString().trim().notEmpty(),
...
export const UpdateCatedraValidator = [
	body("name").exists().isString().trim().notEmpty(),
	body("description").exists().isString().trim(),
	body("programaId").exists().isString().trim().notEmpty(),
...
export const QueryCatedraValidator = [
	query("name").optional().isString().trim().notEmpty(),
	query("programaId").optional().exists().isString().trim().notEmpty(),
